        ...
        <RevealOnScroll className="how-it-works-diagram mt-16">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="grid grid-cols-[1fr_20px_auto_20px_1fr] grid-rows-[auto_auto_1fr] items-center justify-items-center gap-0">
              ...
              <div className="diagram-node diagram-node-top col-span-5 flex flex-col items-center">
              ...
              <div className="diagram-node diagram-node-left col-start-1 row-start-2 flex flex-col items-end justify-start pt-8">
              ...
              <div className="diagram-node diagram-node-line-left col-start-2 row-start-2 flex h-full min-h-[140px] items-center" aria-hidden>
                <div className="h-0.5 w-full origin-center bg-[#1a1a1a]" />
              </div>

              <div className="diagram-node diagram-node-center col-start-3 row-start-2 flex flex-shrink-0 items-center justify-center pt-8 pb-4">
                <div className="diagram-loop flex h-24 w-24 items-center justify-center rounded-full border-2 border-[var(--color-blue-accent)] bg-white px-2 text-center shadow-md sm:h-28 sm:w-28">
              ...
              <div className="diagram-node diagram-node-line-right col-start-4 row-start-2 flex h-full min-h-[140px] items-center" aria-hidden>
                <div className="h-0.5 w-full origin-center bg-[#1a1a1a]" />
              </div>

              <div className="diagram-node diagram-node-right col-start-5 row-start-2 flex flex-col items-start justify-start pt-8">
                <div className="max-w-[200px] rounded-xl border-2 border-[#1a1a1a] bg-white px-3 py-2.5 text-center text-sm font-semibold text-[#1a1a1a] shadow-sm sm:max-w-[220px] sm:px-4 sm:text-base">
